...
:root{
  ...
  --kokona-surface-menu: rgba(255,255,255,.7);
...
async function main() {
  ...
  lines.push(`   hover card bg    : ${a.hoverCardBg}   (must be rgba(255, 255, 255, 0.7) - same as the add menu)`)
  lines.push(`   hover preview bg : ${a.hoverPreviewBg}   (same)`)
  lines.push(`   cmd menu bg      : ${a.cmdMenuBg}   (must be rgba(255, 255, 255, 0.7) - it had no background at all)`)
  lines.push(`   cmd menu blur    : ${a.cmdMenuBlur}`)
  lines.push(`   ADD menu bg      : ${a.addMenuBg}   (must be rgba(255, 255, 255, 0.7) - the real one, _menu + _viewport)`)
