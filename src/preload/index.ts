...
html:not([data-theme="dark"]):not(:has(body[data-ds-dark-theme])) { --kokona-surface-soft: rgba(245, 246, 247, 0.72); --kokona-surface-glass: rgba(255, 255, 255, 0.72); --kokona-surface-chip: rgba(250, 250, 250, 0.72); --kokona-surface-selected: rgba(255, 255, 255, 0.95); --kokona-surface-float: rgba(255, 255, 255, 0.85); --kokona-surface-menu: rgba(255, 255, 255, 0.9); --kokona-selected-ring: rgba(0, 0, 0, 0.35); }
html[data-theme="dark"], body[data-ds-dark-theme] { --kokona-surface-soft: rgba(255, 255, 255, 0.07); --kokona-surface-glass: rgba(255, 255, 255, 0.07); --kokona-surface-chip: rgba(255, 255, 255, 0.07); --kokona-surface-selected: rgba(255, 255, 255, 0.16); --kokona-surface-float: rgba(58, 58, 60, 0.85); --kokona-surface-menu: rgba(58, 58, 60, 0.9); --kokona-selected-ring: rgba(255, 255, 255, 0.9); }
